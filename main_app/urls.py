...
urlpatterns = [
    ...
    path('staff/add_holistic_evaluation/', staff_views.staff_add_holistic_evaluation, name='staff_add_holistic_evaluation'),
    path('staff/get_students/', staff_views.get_students, name='get_students'),
    path('staff/save_holistic_evaluation/', staff_views.save_holistic_evaluation, name='save_holistic_evaluation'),
    path('staff/fetch_evaluation/', staff_views.fetch_evaluation, name='fetch_evaluation'),
    path('staff/view_holistic_evaluations/', staff_views.staff_view_holistic_evaluations, name='staff_view_holistic_evaluations'),
   ...
   # Student
    ...
    path('student/compare-subjects/', student_views.student_compare_subjects, name='student_compare_subjects'),
    path('student/compare-teachers/', student_views.student_compare_teachers, name='student_compare_teachers'),
    path('student/compare-all-teachers/', student_views.student_compare_all_teachers, name='student_compare_all_teachers'),  # New path
    path('student/compare-one-subject/', student_views.student_compare_one_subject, name='student_compare_one_subject'),
    ...
    path('student/view_holistic_evaluation/', student_views.student_view_holistic_evaluation, name='student_view_holistic_evaluation'),
    path('student/compare_holistic_evaluation/', student_views.student_compare_holistic_evaluation, name='student_compare_holistic_evaluation'),
